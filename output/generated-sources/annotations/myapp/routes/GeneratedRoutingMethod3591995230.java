...
@WebResource( path="/redis/{page}/", method="GET" )
public class GeneratedRoutingMethod3591995230 implements HttpHandler {
	...
	@Inject myapp.routes.RedisResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			...
			methodDataProvider.getPathParam( exchange, "page", java.lang.Integer.class )
			 );
