...
public class GeneratedRoutingMethod1540815954 implements HttpHandler {
	...
	@Inject rocker.RockerResource instance;
	...
	public void handleRequest( HttpServerExchange exchange ) throws Exception {
		...
		try {
			final kikaha.urouting.api.Response response = instance.renderTemplate( 
			methodDataProvider.getPathParam( exchange, "templatePath", java.lang.String.class )
			 );
