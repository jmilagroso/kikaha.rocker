...
public class ErrorHandler implements HttpHandler {
    ...
    private final static String ERROR_401 = CustomHandlers.error401Page();
    private final static String ERROR_403 = CustomHandlers.error403Page();
    private final static String ERROR_500 = CustomHandlers.error500Page();
